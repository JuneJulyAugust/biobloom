...
- [ ] **C.** Alignment of duplicated chromosomes at the equator.
...
### 4. The Cre-Lox system can excise a linear piece of the bacterial genome to create a plasmid-like circular sequence. However, these circular stretches usually cannot replicate because they are missing which of the following regions?

- [ ] **A.** Tetracycline resistance sequence.
- [ ] **B.** HSV-tk sequence.
- [ ] **C.** Ubiquitous enhancer sequence.
...
### 7. Specialized cell functions that require a very large PM surface area include all of the following except:

- [ ] **A.** Absorption of nutrients.
- [ ] **B.** Transmission of electrochemical signals over great distance.
- [ ] **C.** Structural and nutritional support of brain tissue (for example, astrocytes).
- [ ] **D.** Waste removal.
...
- [ ] **C.** The ability of ATP synthase to generate protons by shutting electrons from electron carriers.
...
- [ ] **C.** A protein rich in aspartic acid would be purified through anion exchange chromatography.
...
- [ ] **E.** 5’ to 3’ exonuclease.

## 15% Plant Anatomy and Physiology (8 Questions)

### 12. Which of the following statements is TRUE regarding the structure below?

![Question 12 figure 1](images/question12_figure1.png)

- [ ] **A.** It is the site of lateral root development.
- [ ] **B.** It prevents water from being transported via the symplastic route.
- [ ] **C.** It is made primarily of lignin and other hydrophilic substances.
...
- [ ] **C.** Two cambial initial cells, increasing the circumference of the vascular cambium and also dividing to form a secondary xylem cell, but not a secondary phloem cell.
...
- [ ] **A.** They are found in the nonvascular tissue of roots.
- [ ] **B.** They belong to the subgroup: Beta Proteobacteria.
- [ ] **C.** They generate 80% of the usable nitrogen for crops.
...
- [ ] **C.** Active transport of $H^+$ out of a guard cell generates a voltage that drives inward movement of $K^+$ ions, which triggers an osmotic outflow of water that changes cell shape, bowing the guard cells inward and thereby opening the stoma.
...
### 20. Which of these proteins is NOT found in the A band of a relaxed striated muscle cell?
...
- [ ] **C.** The myelin sheath prevents immune attack of exposed axons.
...
- [ ] **C.** Perform the same experiment with an additional inhibitor of clathrin assembly.
...
- [ ] **C.** Macrophages; activation of complement proteins.
- [ ] **D.** Gram negative bacteria; neutralization of antibodies.
- [ ] **E.** Gram negative bacteria; activation of complement proteins.

### 30. All of the following are benefits of intravenous drug delivery over oral drug delivery EXCEPT:

- [ ] **A.** Intravenously delivered drugs avoid chemical modification by liver enzymes.
- [ ] **B.** Intravenously delivered drugs tend to be associated with higher patient compliance.
- [ ] **C.** Intravenously delivered drugs can be administered in lower doses.
...
- [ ] **C.** Within gills, the pumps, cotransporters, and channels of specialized chloride cells function together to drive salt from the blood across the gill epithelium and into the surrounding saltwater.
- [ ] **D.** Within gills, chloride and potassium ions are transported inside of the cell, which then results in co- transport of sodium and potassium ions, in which sodium ions are pumped in and potassium ions are pumped out.
- [ ] **E.** Within gills, chloride and potassium ions are transported inside of the cell, which then results in co- transport of sodium and potassium ions, in which potassium ions are pumped in and sodium ions are pumped out.

## 5% Ethology (2 Questions)

### 32. Which of the following is an example of a negative punishment in operant conditioning?

- [ ] **A.** A lion being taught to jump through a flaming hoop is given a painful electric shock for each failed jump attempt.
- [ ] **B.** A mother temporarily takes away her child’s favorite gaming console each time her child receives a failing grade in school.
...
- [ ] **C.** Males are likely to be more affected than females.
...
- [ ] **C.** III-2 has a 75% chance of having inherited a mutated FMR1 from his mother.
...
- [ ] **C.** Testing for gene products, such as proteins, is a more reliable indicator of future disease development than sequencing genes themselves, because of DNA methylation.
...
- [ ] **C.** Products of nitrogen fixation act as a repressor of the inducer of photosynthetic enzymes.
- [ ] **D.** Photosynthesis occurs under reducing conditions while nitrogen fixation occurs under oxidizing condition.
- [ ] **E.** Cyanobacterium has an unique molecular machinery similar to alternative splicing of genes, which results in enabling activation of one gene at a time.

### 41. Which of the following would arise through negative frequency-dependent selection?

- [ ] **A.** Warning coloration against predators.
- [ ] **B.** An outbreak of antibiotic-resistant S. aureus.
- [ ] **C.** Domination of black fur in a mouse population following a deadly hurricane.
- [ ] **D.** Batesian mimicry.
...
- [ ] **A.** The inheritance of the dextral and sinistral phenotypes is an example of the maternal effect.
- [ ] **B.** The dextral phenotype is dominant to the sinistral phenotype
- [ ] **C.** If an F1 female is crossed with a true-breeding sinistral male, the ratio of sinistral offspring to dextral offspring would be 1:1.
...
- [ ] **C.** The production of tougher sepals to protect against nectar robbing is an example of enforcement because investment of resources by the flowering plant punishes nectar robbing and promotes cooperation.
...
- [ ] **B.** A bacterium produces genetically identical offspring through binary fission.
- [ ] **C.** A loggerhead turtle produces 300 eggs every other year throughout its 45 year lifespan.
...
### 47. If one were to assess fitness of an individual bird, which of the following would be done?

- [ ] **A.** Calculate the instantaneous grow rate of a population and compare it to other populations.
- [ ] **B.** Count the number of offspring produced.
- [ ] **C.** Count the number of second generation offspring produced.
- [ ] **D.** Count the number of offspring produced relative to the average number of offspring in the population.
- [ ] **E.** Determine the distance the bird is able to fly before needing to feed.

### 48. Toxins in the food chain are magnified as trophic levels increase due to:

- [ ] **A.** Higher trophic levels are mostly filled with many less-complex organisms.
- [ ] **B.** Increasing concentration of toxins occurs more widely in the tissues of sensitive organisms.
...
### 50. Which of the following is incorrectly paired its bacterium and its key characteristics?

- [ ] **A.** Mycoplasma - lack cell wall.
- [ ] **B.** Chlamydias- lack peptidoglycan.
